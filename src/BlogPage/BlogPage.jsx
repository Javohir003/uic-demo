...
import Post1 from "/public/assests/Post-Img/Post1.jpg";
import Post2 from "/public/assests/Post-Img/Post2.jpg";
import Post3 from "/public/assests/Post-Img/Post3.jpg";
import Post4 from "/public/assests/Post-Img/Post4.jpg";
import Post5 from "/public/assests/Post-Img/Post5.jpg";
import Post6 from "/public/assests/Post-Img/Post6.jpg";
import Post7 from "/public/assests/Post-Img/Post7.jpg";
import Post8 from "/public/assests/Post-Img/Post8.png";
import Post9 from "/public/assests/Post-Img/Post9.jpg";
import Post10 from "/public/assests/Post-Img/Post10.jpg";
                      ...
                      <div className="Post-title-text">
                        <article className="post-blog-text-title">
                          ...
                          <p>
                            ...
                            experience in project management, founder of the Sello
                            brand, holder of PMI, PMP certificates
                          </p>
                          <hr className="hrStyle" />
                          <div className="icon-Blogs">
                            <div className="kalendar-Block">
                    ...
                    <div className="Img-Parent">
                      ...
                      <div className="Post-title-text">
                        <article className="post-blog-text-title">
                          ...
                          <p>
                            The use of various applications for financial services
                            and money transfers has become increasingly popular in
                            recent years. We offer ready-made solutions for
                          </p>
                          <hr className="hrStyle" />
                          <div className="icon-Blogs">
                            <div className="kalendar-Block">
                    ...
                    <div className="Img-Parent">
                      ...
                      <div className="Post-title-text">
                        <article className="post-blog-text-title">
                          ...
                          <p>
                            Business Quiz - is the largest entertainment business
                            event and intellectual competition in Uzbekistan,
                            which brings together hundreds of leaders and top
                          </p>
                          <hr className="hrStyle" />
                          <div className="icon-Blogs">
                            <div className="kalendar-Block">
                  ...
                  <div className="Blog-Post-Left-Img-Blog">
                    <div className="Img-Parent">
                      ...
                      <div className="Post-title-text">
                        <article className="post-blog-text-title">
                          <span>
                            A representative of UIC Group took part in the finals
                            of the NEERC
                          </span>
                          <p>
